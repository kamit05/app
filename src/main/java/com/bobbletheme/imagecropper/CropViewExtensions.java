...
class CropViewExtensions {
    ...
    public static class LoadRequest {
        ...
        LoadRequest(CropView cropView) {
            CropViewUtils.checkNotNull(cropView, "cropView == null");
...
//        }
    ...
    public static class CropRequest {
        ...
        public CropRequest format(@NonNull Bitmap.CompressFormat format) {
            CropViewUtils.checkNotNull(format, "format == null");
            this.format = format;
            return this;
        }
        ...
        public CropRequest quality(int quality) {
            CropViewUtils.checkArg(quality >= 0 && quality <= 100, "quality must be 0..100");
        ...
        public Future<Void> into(@NonNull File file) {
            ...
            return CropViewUtils.flushToFile(croppedBitmap, format, quality, file);
        }
        ...
        public Future<Void> into(@NonNull OutputStream outputStream, boolean closeWhenDone) {
            final Bitmap croppedBitmap = cropView.crop();
            return CropViewUtils.flushToStream(croppedBitmap, format, quality, outputStream, closeWhenDone);
        }
    }
